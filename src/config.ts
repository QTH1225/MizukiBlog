...
export const siteConfig: SiteConfig = {
	title: "Tianhao",
	subtitle: "Tianhao 's Blog",
	siteURL: "https://qintianhao.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-09-13", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	font: {
		...
		asciiFont: {
			...
			fontWeight: "500",
			localFonts: ["noto-serif-sc-latin-500-normal.woff2"],
			enableCompress: false, // 禁用字体子集优化，在开发环境预览效果
		},
		cjkFont: {
			// 中日韩字体 - 作为回退字体
			fontFamily: "LXGW WenKai", // 使用霞雾文楷字体
			fontWeight: "400",
			localFonts: ["LXGWWenKai-Regular.ttf"], // 使用霞雾文楷字体文件
			enableCompress: false, // 禁用字体子集优化，在开发环境预览效果
		},
	},
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoocom.netlify.app/.netlify/functions/twikoo",
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "Welcome to my blog! If you have any questions or suggestions about my blog, please contact me in time.", // 公告内容
...
export const umamiConfig = {
	...
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="91e55e52-69d0-4093-a821-b77360369aa1"></script>
